...
export const trendingMovies = async () => {
  try {
    const { data } = await axios.get(
      `${BASE_URL}/trending/movie/day?api_key=${API_KEY}&languange=en-US`
    );
...
export const topRatedMovies = async () => {
  try {
    const { data } = await axios.get(
      `${BASE_URL}/movie/top_rated?api_key=${API_KEY}&languange=en-US`
    );
    return data && data.results;
  } catch (error) {
    console.log(error);
...
export const popularMovies = async () => {
  try {
    const { data } = await axios.get(
      `${BASE_URL}/movie/popular?api_key=${API_KEY}&languange=en-US`
    );
    return data && data.results;
  } catch (error) {
    console.log(error);
